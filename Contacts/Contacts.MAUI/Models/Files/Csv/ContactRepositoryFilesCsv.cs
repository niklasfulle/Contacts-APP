...
{
    public static class ContactRepositoryFilesCsv
    {
        private static readonly string _fileName = FileSystem.AppDataDirectory + "/Contacts.csv";

        public static List<Contact> _contacts = new List<Contact>();

        public async static void WriteToFile()
        {
            CsvWriter.WriteToCsv(_fileName, _contacts);
        }
        ...
        public async static void ReadFromFile()
        {
            ...
            _contacts = CsvReader.ReadCsvFile(_fileName);
        }
